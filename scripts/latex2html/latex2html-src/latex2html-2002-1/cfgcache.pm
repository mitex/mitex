...
$cfg{'TEXPATH'} = q'/etc/texmf/tex/latex/html';
...
$cfg{'scriptext'} = q'';
$cfg{'srcdir'} = q'/afs/athena.mit.edu/user/j/g/jgross/web_scripts/mitex/scripts/latex2html/latex2html-src/latex2html-2002-1';
$cfg{'texlive'} = q'0';
$cfg{'wrapper'} = q'0';
